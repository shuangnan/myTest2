<template>
  <div style="height: 100%; width: 100%; display: flex; flex-direction: column">
    <div style="height: 85.3px; width: 100%; padding: 10px; display: flex; flex-direction: row">
      <div :style="dw_xhj"></div>
      <div style="height: 100%; width: calc(100% - 71px); display: flex; flex-direction: column; align-items: center; justify-content: center">
        <span style="font-size: 16px; font-weight: bold">信号机</span>
...
<script>
import dw_xhj from './dwXhjPopperStyle'
export default {
  name: "dwXhjPopper",
