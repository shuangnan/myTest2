...
<script>
import dwLksbwPopperStyles from "./dwLksbwPopperStyle";
export default {
  name: "dwLksbwPopper",
  ...
  methods: {
    initData () {
      ...
      console.log( '获取列控设备信息', popperStr )
