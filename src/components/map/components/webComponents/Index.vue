<template>
  <div class="lay-con">
    <div class="lay" :class="{'big':bigScreen}">
      ...
      <div class="center-con">
        <div class="map-con2">
          <Map
            ...
            :toolsConfig="{left:'5px',bottom:'50px',height:'750px',lateRight:'440px'}"
          ></Map>
        </div>
      ...
      <!-- 左翅膀屏 -->
      <!-- <div v-if="hasLRView" class="wing-view left" :class="wingView.left" style="z-index:999">
      ...
      <!-- 右翅膀屏 -->
      <!-- <div v-if="hasLRView" class="wing-view right" :class="wingView.right" style="z-index:999">
