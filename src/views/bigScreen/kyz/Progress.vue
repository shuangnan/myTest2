    ...
    <div class="wc_item">
      ...
      <div class="wc_item_3">
        <div style="height:100%;height:100%;position: relative;font-size:12px;">
          <div class="pro_progress">
            <div class="proGress_div" :style="{'background':pgColor}">
              <div style="overflow:hidden" :style="{'background':pgWCColor,width:wcPrev*100+'%'}">
                <transition>
                  <table
                    class="proGress_div_G"
                    :style="{'animation-duration':(wcPrev*10/1.3).toFixed(1)+'s'}"
                  >
                    <tbody>
                      <tr>
                        <td
                          v-for="item in getG_num"
                          :key="item"
                          :style="{'box-shadow':'0px 0px 4px 2px '+ydColor}"
                        ></td>
                      </tr>
                    </tbody>
                  </table>
          ...
          <div class="pro_numItem" :style="{left:getCYNum(bbNum,fdNum*allPie)*100+'%'}">
          ...
          <div class="pro_numItem" :style="{left:getCYNum(fdNum,fdNum*allPie)*100+'%'}">
            <div class="pro_numItemContent">
