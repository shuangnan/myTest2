...
<template>
    <div class="main">
        <div style="width:100%;height:calc(50% - 20px);" class="CR1_FC">
            <table class="CR1_TAB">
                <tr>
                    <td class="shadow-txt fsqb_bg" style="font-size:24px;font-weight:bold;">{{num1}}</td>
                    <td class="shadow-txt qsqb_bg" style="font-size:24px;font-weight:bold;">{{num2}}</td>
                    <!-- <td rowspan="2">
        ...
        <div style="width:100%;height:50%;" ref="con">
            ...
            >
                <el-carousel-item v-for="(item,index) in dataList" :key="index">
                    <div class="s-div">
                        <div v-for="(temp,i) in item" :key="i" class="CR1_FG">
...
.s-table > tbody > tr {
    height: 62px;
    background: url("../kyd/img1/CR1_2.png") no-repeat;
    background-size: 100% 46px;
    background-position: 0px 8px;
}
.fsqb_bg {
    vertical-align: top;
    background: url("../kyd/img1/CR1_qb1.gif") no-repeat;
    background-position: center bottom;
    background-size: auto 80%;
}
.qsqb_bg {
    vertical-align: top;
    background: url("../kyd/img1/CR1_qb2.gif") no-repeat;
    background-position: center bottom;
    background-size: auto 80%;
}
.s-div {
